...
SECRET_KEY = 'django-insecure-&82=yx0k^6n-p#v_(0)u)0zag#=mc86s6u99eo^o7+)zb4u$#i'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
         'DIRS': [
            BASE_DIR / "jobboard" / "templates",  # 👈 add this
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                # provide unread message counts to templates
